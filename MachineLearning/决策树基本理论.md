...
<font face="宋体" size=5>
    ...
    <p>&emsp;&emsp;当熵和条件熵中的概率由数据估计（特别是极大似然估计）得到时，所对应的熵和条件熵分别称为经验熵（empirical entropy）和经验条件熵（empirical conditional entropy）。此时，如果有0概率，令0log0=0。</p>
    <p></p>
...
<font  face="宋体" size=5>
    <ol>
        <li>《统计学习方法》</li>
        <li><a href="http://www.cnblogs.com/pinard/p/6050306.html">决策树算法原理（上）</a></li>
        <li><a href="http://www.cnblogs.com/pinard/p/6053344.html">决策树算法原理（下）</a></li>
    </ol>
</font>
