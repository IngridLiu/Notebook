...
<div align="center">
    <img src="https://latex.codecogs.com/gif.latex?I_R(D,A)&space;=&space;\frac{I(A,D)}{H_A(D)}" title="I_R(D,A) = \frac{I(A,D)}{H_A(D)}" />
</div>
<p>
    <font face="宋体" size=5>   
        &emsp;&emsp;
